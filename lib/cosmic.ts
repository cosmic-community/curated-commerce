...
import type { Product, Collection, Review, Page, BlogPost } from '@/types'
...
// Changed: Added function to fetch all blog posts
...
// Changed: Added function to fetch a single blog post by slug
